...
class CollectionDetailPage extends React.Component {
    ...
    selectAssessment() {
        ...
        if (this.state.isWebResource) {
            window.location = "/upload-web-resource?col=" + this.props.match.params.collection_id;
        } else {
            window.location = "/upload?col=" + this.props.match.params.collection_id;
        }
    }
    selectPlan() {
    ...
    render() {
        if (this.props.searchdata.isFetching) {
            ...
            var isShared = query.get("isShared");
            const docs = [];
            this.props.searchdata.collection_detail.docs.map( (item, i) => {
                docs.push(
                    <DocCard 
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-4">
                            <EditableColCard showEditImageModal={this.showEditImageModal} noHoverEffect={isShared === 'true'}
                                thumbnail={this.props.searchdata.collection_detail.thumbnail}/>
                        </div>
                        
                        <div className="col-md-8">
                            {!this.state.changeInput && 
                                <div onClick={ isShared === 'true' ? "" : this.changeInput}>
                            ...
                            <div className="btn-container">
                                {(this.props.match.params.uuid === undefined && isShared !== 'true') &&
...
export default withRouter(CollectionDetailPage);
