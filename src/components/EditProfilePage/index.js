...
class EditProfilePage extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.basedata.profileData.selected_school !== this.props.basedata.profileData.selected_school) {
            this.setState({ selected_school: nextProps.basedata.profileData.selected_school });
        }
        
        if (nextProps.basedata.profileData.selected_general_tags !== this.props.basedata.profileData.selected_general_tags) {
            this.setState({ selected_general_tags: nextProps.basedata.profileData.selected_general_tags });
        }

        if (nextProps.basedata.profileData.selected_grades !== this.props.basedata.profileData.selected_grades) {
            this.setState({ selected_grades: nextProps.basedata.profileData.selected_grades });
        }

        if (nextProps.basedata.profileData.selected_role !== this.props.basedata.profileData.selected_role) {
            this.setState({ selected_role: nextProps.basedata.profileData.selected_role });
        }

        if (nextProps.basedata.profileData.selected_student_needs !== this.props.basedata.profileData.selected_student_needs) {
            this.setState({ selected_student_needs: nextProps.basedata.profileData.selected_student_needs });
        }

        if (nextProps.basedata.profileData.selected_subjects !== this.props.basedata.profileData.selected_subjects) {
            this.setState({ selected_subjects: nextProps.basedata.profileData.selected_subjects });
        }
    }
    ...
    handleClick = () => {
        if ( this.isFormValid() ) {
            ...
            this.props.updateProfile(register_info, this.props.nextPage);
        }
    }
    ...
    render() {
        if (this.props.basedata.isFetching) {
            ...
            console.log(this.props.basedata.profileData);
            return (
                            ...
                            <div className="input-group">
                                <div className="col-md-12">
                                    ...
                                    <div className="text-center">
                                        <button onClick={ this.handleClick } className="btn mt-4">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
